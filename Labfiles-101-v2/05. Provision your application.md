...
1. On the **Network security groups** page, Select the **nsg-spoke1-<inject key="DeploymentID" enableCopy="false"/>**. 
    ...
    ![Create resource](./Media/101-14.png)
...
1. On the **Network security groups** page, Select the **nsg-spoke2-<inject key="DeploymentID" enableCopy="false"/>**. 
    ...
    ![Create resource](./Media/101-17.png)
...
1. In LabVM-<inject key="DeploymentID" enableCopy="false"/> open a new tap on the **Microsoft edge** and browse **spoke1VM<inject key="DeploymentID" enableCopy="false"/>** Public IP address to access the web page.
...
1. In LabVM-<inject key="DeploymentID" enableCopy="false"/> open a new tap on the **Microsoft edge** and browse **spoke2VM<inject key="DeploymentID" enableCopy="false"/>** Public IP address to access the web page.
...
1. Minimize, the spoke2VM<inject key="DeploymentID" enableCopy="false"/> VM.
...
1. Fill out as per the screen below to **allow** on-premises **RDP** access to the **spoke1VM<inject key="DeploymentID" enableCopy="false"/>** as follows:
   ...
   - Click on **Add (4)**
      ...
      >**Note**: We need **RDP** port for **spoke1VM<inject key="DeploymentID" enableCopy="false"/>** to perform **Exercise 5**.
