...
1. From your **DBVM-<inject key="DeploymentID" enableCopy="false"/>** Search for **Powershell (1)**, right-click on a **Windows Powershell (2)**, select **Run as administrator (3)**.
