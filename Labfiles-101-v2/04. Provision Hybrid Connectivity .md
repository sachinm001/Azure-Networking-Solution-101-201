...
1. On the **Basics** tab, enter the following information:
   ...
   - **Region (5)** : Select **West US** from the drop-down.
...
1. Under Connectivity select **VPN (site to site) (1)**. Inspect the VPN Site is successfully **connected (2)**. 
   ...
   >**Note** : VPN site may take some time to get connected,  Keep refreshing the page until status changed to **Connected**.
