...
1. On the **Links** page, fill in the following information:
    ...
    - **Link name** : Enter **Onprem-ISP (1)**
    - **Link speed**: Enter **1000 (2)**
    - **Link provider name**: Enter **ISP-provider (3)**
    - **Link IP address/FQDN**: Enter **Public IP of on-prem VPN gateway (4)**.
...
- **Pre-shared key PSK** : enter **0123456789 (1)**
...
1. On the **Basic** page, fill in the following information:
    ...
    - **IP address** : Enter **Public IP address for VPN Gateway instance 0 (6)** 
    - **Address space (s)** : Enter 
      ...
      - Address space of **DNSresolvervnet(10.5.0.0/16) (7)**
