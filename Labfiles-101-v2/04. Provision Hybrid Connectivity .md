...
1. On the **Create VPN Gateway** page, perform the following steps:
   ...
   >**Note**: This may take up to 30 minutes for the update. wait for it to get updated.
...
1. Navigate back to the Azure portal, in the search box, type **Local Network gateway (1)** and select **Local Network gateway (2)** from the results.
