...
1. Congratulations! You successfully connected your **LABVM** to **spoke2VM<inject key="DeploymentID" enableCopy="false"/>**. Now click on the **Next** button present in the bottom-right corner of this lab guide.
