...
1. On the **vwan-prod-001** page, select **Virtual network connections (1)** under Connectivity. By clicking on the drop-down symbol next to **Virtual network (2)**, you can see **vnet-shared-services-<inject key="DeploymentID" enableCopy="false"/> (3)**, **vnet-spoke1-<inject key="DeploymentID" enableCopy="false"/> (3)** and **vnet-spoke2-<inject key="DeploymentID" enableCopy="false"/> (3)** have already connected with **vwan-hub-prod-001**.

   ![Create resource](../media/y182.png)
