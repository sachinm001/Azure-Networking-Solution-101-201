...
1. Open the path where you have exported the root certificate such as `C:\temp` and right-click on the **rootcertification (1)**, click on **Open with (2)** and select **Notepad (3)**.
