...
1. On the **vpn-gatway-prod-001|Point-to-site configuration** enter the following information:
   ...
   - **Address pool (1)** box: add the **172.16.0.0/16** private IP address range. 

   - **Tunnel type (2)** box: Select **IKEv2** from the drop-down.

   - **Authentication type (3)** box: Select **Azure certificate** from the drop-down.
...
1. Enter the file name as **rootcertificate.cer (1)** and click on **Save (2)**.
...
1. Open the path where you have exported root certificate such as `C:\temp` and right click on the 
**rootcertification (1)**, click on **Open with (2)** and select **Notepad (3)**.
...
1. In the LabVM search for **vpn (2)** and select **VPN settings (3)**
