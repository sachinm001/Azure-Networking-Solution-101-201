...
1. From the **Home** page of Azure Portal, type **Network Watcher (1)** in the search box and then click on it **(2)**.
...
1. In the **Home** page of Azure Portal, type **Storage accounts (1)** on the search box and then click on it **(2)**. 
...
1. Under the **Scope** tab, click on **+ Select scope**.
...
1. Under the **Condition** page, follow the below steps: 
