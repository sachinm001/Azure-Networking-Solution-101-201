...
## Task 6: Deploy Network Monitoring Solution.
...
1. On the **Add souces** blade, select type as **Virtual Machines (1)**, and select vnet as **Onprem-Gatewayvnet-<inject key="DeploymentID" enableCopy="false"/> (2)**, To view the virtual machines on the vnet, click **Selected sources (2 Azure endpoints) (3)** and select **Add endpoints (4)**.
