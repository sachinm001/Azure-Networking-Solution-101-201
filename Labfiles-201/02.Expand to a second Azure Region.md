...
## Solution Architecture
   ...
   ![](/media-201/Infra-Networking-201-2.1.jpg)
...
1. On the **Connect (1)** page under Settings, click on **Select (2)** under **Native RDP** and click on **Download RDP file (3)**. A file will download on the bottom left of your screen and click on **Close (4)**.
