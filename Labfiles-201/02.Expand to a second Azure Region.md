...
1. In the search bar of the Azure portal, search **Virtual WANs (1)**, then click on **Virtual WANs (2)** under **Services**.
...
1. In the search bar of the Azure portal, type **Virtual network gateways (1)**, and then select **Virtual network gateways (2)** from the results.
...
1. In the search box, search **Local network gateways (1)** and select **Local network gateways (2)** from the results.
...
1. Navigate to the Azure portal, type **Virtual machines (1)**, then select **Virtual machines (2)** under **Services**.

   ![Create resource](../media/95.png)

1. From the **Virtual machines** page, select **spoke3VM<inject key="DeploymentID" enableCopy="false"/>**.
