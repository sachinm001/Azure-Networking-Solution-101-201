...
1. Go back to **vwan-prod-001 | Virtual network Connections**, click on the drop-down symbol next to **Virtual networks (1)**, you can see **vnet-shared-services2-<inject key="DeploymentID" enableCopy="false"/> (2)**, **vnet-spoke3-<inject key="DeploymentID" enableCopy="false"/> (2)** and **vnet-spoke4-<inject key="DeploymentID" enableCopy="false"/> (2)** created.
...
1. On the **Basics** tab, enter the below details:
   ...
   - **Region (5)**: Select **East US** from the drop-down list.
...
- Configured secondary Hub and created Virtual network gateway.
...
- Confirmed and Tested inter-VM connectivity among primary and secondary region.
