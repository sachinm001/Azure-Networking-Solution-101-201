...
1. In the search bar of the Azure portal, search **Virtual network gateways (1)**, and then select **Virtual network gateways (2)** from the results.
...
1. Select the VPN site **on-prem-2 (1)** then click on the **Connect VPN sites (2)**.
