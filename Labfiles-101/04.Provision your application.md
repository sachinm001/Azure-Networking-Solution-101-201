...
1. Go back to the Azure porter, on the **Basics** tab of vpn-gatway-prod-001 | connections page, Select **Connections (1)**, you can notice the **vpn-connection-001** status is now turned into **connected (2)**.
