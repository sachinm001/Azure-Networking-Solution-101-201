...
1. On Networking tab, enter the following information and the click **OK(6)** button at the bottom of the page :

    - Virtual network: **Create new (1)**
    - Name: **vnet-prod-003 (2)**
    - Address range: **10.4.0.0/16 (3)**
    - Subnet name: **default (4)**
    - Addreess range: **10.4.0.0/24 (5)**
