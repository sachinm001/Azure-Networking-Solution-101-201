...
1. Once Validation is passed, review the configuration, and click on **Create**.
...
1. In the Azure portal, in the search box, type **Local Network gateway (1)** and select **Local Network gateway (2)** to open it.
...
1. Go back to the Azure portal, on the **Basics** tab of vpn-gatway-prod-001 | connections page, Select **Connections (1)**, you can notice the **vpn-connection-001** status is now turned into **connected (2)**.
