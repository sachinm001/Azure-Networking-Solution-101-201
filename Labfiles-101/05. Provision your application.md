...
1. Now, paste the Prive IP address from the **vm-prod-002**| Overview page, that you have copied in the previous task paste it into a new tab, and hit enter key on the keyboard. You'll be directed to the webpage as shown in the screenshot below.
...
1. On the **vwan-prod-001** page, select **Hubs(1)** under **Connectivity** blade and you can notice the status of **vwan-hub-prod-001** created is in **Succeeded(2)** state.
...
1. Now, paste the Prive IP address from the **vm-prod-002**| Overview page, that you have copied in the previous task paste it into a new tab, and hit the enter key on the keyboard. You'll be directed to the webpage as shown in the screenshot below.
