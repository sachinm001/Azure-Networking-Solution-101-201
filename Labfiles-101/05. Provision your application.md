...
1. Now, paste the Prive IP address from the **vm-prod-002**| Overview page, that you have copied in the previous task and paste it into a new tab, and hit enter key on the keyboard. You'll be directed to the webpage as shown in the screenshot below.
